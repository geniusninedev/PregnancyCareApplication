...
public class CardioWorkout extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] warmUpExcercise = new String[]{
                ...
                "*Perform this move without the dumbbells.\n" +
                        "*Hold yourself in the B position for 30 seconds then repeat on your other leg.\n" +
                        "\n\n\n\n\n\n\n",
        ...
        int[] images = new int[]{R.drawable.dbell_bulg_split_squat,
        ...
        adapter = new ViewPagerAdapter(CardioWorkout.this, images, warmUpExcercise);
